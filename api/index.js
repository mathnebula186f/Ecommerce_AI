...
app.post("/sendMessage", async (req, res) => {
  ...
  const { recipient, text, sender,answer } = req.body;
  console.log(recipient,text,sender,answer)
  ...
  try {
    ...
    const messageDoc1 = await Message.create({
      sender: recipient,
      recipient: sender,
      text: answer,
    });
    ...
    res
      .status(200)
      .json({ message: "Message sent successfully", data: {messageDoc,messageDoc1} });
  } catch (error) {
